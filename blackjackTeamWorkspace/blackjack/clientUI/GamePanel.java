...
{	
	// Private data fields for the important GUI components.
	  ...
	  public GamePanel(GameControl gc)
	  {
	    ...
	    JPanel GamePanel = new JPanel(new GridLayout(2, 2, 5, 5));
	    ...
	    submitButton.addActionListener(gc);
	    JButton cancelButton = new JButton("Cancel");
	    cancelButton.addActionListener(gc);    
	    ...
	    grid.setBackground(new Color(10, 100, 35));
	    this.add(grid);
	    this.setBackground(new Color(10, 100, 35));
	  }
}
